...
#ifndef PRX_BULLET_SIMULATOR_HPP
#define PRX_BULLET_SIMULATOR_HPP
    ...
    namespace sim
    {
        ...
        class bullet_simulator_t : public simulator_t
        {
          ...
          public:
            ...
            virtual void create_rigid_bodies(plant_t* plant);
          ...
          private:
            ...
            std::vector<std::pair<btCollisionShape*, btRigidBody*> > kinematic_rigid_bodies;
            ...
            util::config_list_t kinematic_configurations;
