...
namespace prx
{
    ...
    namespace plan
    {
        ...
        class planning_context_info_t
        {
          public:
            planning_context_info_t(){}
            virtual ~planning_context_info_t(){}
        };
        ...
        class planning_context_t
        {
          ...
          public:
            ...
            /** @brief Extra information for planning contexts.*/
            planning_context_info_t* info;
        ...
        class world_model_t
        {
          ...
          public:
             ...
             */
            void propagate_plan(const sim::state_t * const state, const sim::plan_t& plan, sim::trajectory_t& traj);
            ...
            /**
             * @brief Stitches the input points to the output points.
             * 
             * @details It takes the input points, puts them into the input spaces and 
             * output points are created using the output spaces and the information from the input points.
             * All the input points will be added in the space memory in order. If there is an overlap between
             * input spaces the values will be overwritten. 
             * 
             * @param output_spaces The spaces that will be used in order to generate the new output points.
             * @param output_points The new generated points after the stitching. 
             * @param input_spaces The spaces that will be used to put the input points inside the memory.
             * @param input_points The points with the information that we want to stitch.
             */
            void stitch_spaces(const std::vector<util::space_t*>& output_spaces, const std::vector<util::space_point_t*>& output_points,const std::vector<util::space_t*>& input_spaces, const std::vector<util::space_point_t*>& input_points);            


            /**
             * @brief Stitches the input point to the output point.
             * 
             * @details It takes the input point, puts it into the input space and 
             * output point is created using the output space and the information from the input point.
             * 
             * @param output_space The space that will be used in order to generate the new output point.
             * @param output_point The new generated point after the stitching. 
             * @param input_space The space that will be used to put the input point inside the memory.
             * @param input_point The point with the information that we want to stitch.
             */
            void convert_spaces(const util::space_t* output_space, util::space_point_t* output_point,const util::space_t* input_space, const util::space_point_t* input_point);            
             ...
             */
            static pluginlib::ClassLoader<world_model_t>& get_loader();
          ...
          protected:
            ...
            std::vector<util::mapping_function_t*> subset_state_mappings;

            std::vector<util::mapping_function_t*> subset_control_mappings;
          ...
          private:
             ...
             */
            static pluginlib::ClassLoader<world_model_t> loader;
        };
