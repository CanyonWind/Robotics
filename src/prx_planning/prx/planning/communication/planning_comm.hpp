        ...
        namespace comm
        {
            ...
            class planning_comm_t : public plan_base_communication_t
            {
              ...
              public:
                ...
                /**
                 * Requests ground truth information from the simulation node
                 * 
                 * @return std::vector<double> the doubles corresponding to the state memory of the full state space of the world model
                 */
                virtual std::vector<double> request_ground_truth();
            };
