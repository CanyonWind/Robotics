...
#ifndef PRX_MULTI_QUERY_APPLICATION_HPP
#define	PRX_MULTI_QUERY_APPLICATION_HPP
...
namespace prx
{
    namespace plan
    {
         ...
         */
        class multi_query_application_t : public planning_application_t
        {

          public:
            multi_query_application_t();
            virtual ~multi_query_application_t();
