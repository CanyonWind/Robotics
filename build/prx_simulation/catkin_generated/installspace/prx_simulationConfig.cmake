...
if(NOT "include;/usr/include;/opt/ros/indigo/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'prx_simulation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/parallels/Desktop/ROS_workspace/install/${idir}'.  Ask the maintainer 'Kostas Bekris <kostas.bekris@cs.rutgers.edu>' to fix it.")
    endif()
